...
mod tests {
    ...
    fn test_beast_status_decrease_beast_at_100_and_awake() {
        ...
        println!("[Decrease test] Initial Status - energy: {}, Energy: {}, Hygiene: {}, Hunger: {}, Is Awake: {}, Is Alive {}", 
        status.energy, status.energy, status.hygiene, status.hunger, status.is_awake, status.is_alive);
