...
export const dojoConfig = createDojoConfig({
    ...
    rpcUrl: VITE_PUBLIC_NODE_URL || 'https://api.cartridge.gg/x/bytebeaststamagotchi/katana',
    toriiUrl: VITE_PUBLIC_TORII || 'https://api.cartridge.gg/x/bytebeaststamagotchi/torii',
});
