...
const DOMDoodleGame = forwardRef<DOMDoodleGameRefHandle, DOMDoodleGameProps>(({
  ...
  const handleGameEnd = () => {
    ...
    // Registrar la comida recolectada
  ...
  const placePlatforms = () => {
    ...
    const initialPlatform = {
      ...
      hasFood: false, // La plataforma inicial nunca tendrá comida
      foodCollected: false,
    ...
    game.platforms.forEach(platform => {
      ...
      // Añadir comida a algunas plataformas
  ...
  const newPlatform = () => {
    ...
    // Si tiene comida, añadir el elemento visual
    if (platform.hasFood) {
      const food = getRandomFood();
      const foodElement = document.createElement('div');
      foodElement.className = 'platform-food';
